...
<html>
    ...
    <body>
        ...
        <form action="<?=$_SERVER['PHP_SELF']?>" method="post">
            <table>
                <tr>
                    <th colspan="5"><h1>Catálogo de empleados</h1></th>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <a href="listaemp.php">Mostrar todos los empleados</a>
                    </td>
                    <td>
                        <a href="agregaemp.php">Agrega empleado</a> 
                    </td>
                </tr>
            </table>
                            ...
                            ?>
                             <tr>
                                ...
                                <td><?php echo $filas['rfc_emp'] ?>   </td>
   	  		                    ...
   	  		                    <td>
   	  			                   <?php echo "<a href='editaemp.php?cve_emp=".$filas['cve_emp']."'>EDITAR</a>"; ?>
   	  			                   -
   	  			                   <?php echo "<a href='eliminaemp.php?cve_emp=".$filas['cve_emp']."'
